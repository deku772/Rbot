...
public final class BotDropConstants {
    ...
    /** Marker file indicating AstrBot is installed */
    public static final String ASTRBOT_MARKER = ASTRBOT_HOME + "/.botdrop-astrbot-ready";
    ...
    public static final String LOCAL_ROOTFS_SRC = "/storage/emulated/0/claw-apk/ubuntu22_openclaw.tar.gz";
    ...
    /** App package name */
    public static final String PACKAGE_NAME = "app.botdrop";
