...
class StartAdbViewHolder(binding: HomeStartAdbBinding, root: View) : BaseViewHolder<Any?>(root) {
    ...
    init {
        binding.button1.setOnClickListener { v: View ->
            ...
            RbotAnalytics.logEvent(context, "automation_shizuku_computer_start_tap")
            MaterialAlertDialogBuilder(context)
                ...
                .setPositiveButton(R.string.home_adb_dialog_view_command_copy_button) { _, _ ->
                    RbotAnalytics.logEvent(context, "automation_shizuku_computer_start_copy_tap")
                ...
                .setNeutralButton(R.string.home_adb_dialog_view_command_button_send) { _, _ ->
                    RbotAnalytics.logEvent(context, "automation_shizuku_computer_start_send_tap")
                ...
                .show()
            RbotAnalytics.logEvent(context, "automation_shizuku_computer_start_dialog_shown")
        }
