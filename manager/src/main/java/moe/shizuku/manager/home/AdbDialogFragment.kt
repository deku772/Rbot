...
class AdbDialogFragment : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        RbotAnalytics.logEvent(context, "automation_shizuku_start_dialog_shown")
    ...
    private fun onDialogShow(dialog: AlertDialog) {
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
            RbotAnalytics.logEvent(it.context, "automation_shizuku_start_settings_tap")
    ...
    private fun startAndDismiss(port: Int) {
        RbotAnalytics.logEvent(requireContext(), "automation_shizuku_start_submit")
        val host = "127.0.0.1"
