...
class AdbPairingTutorialActivity : AppBarActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        RbotAnalytics.logScreen(this, "automation_shizuku_pair_tutorial", "AdbPairingTutorialActivity")
        ...
        binding.apply {
            ...
            developerOptions.setOnClickListener {
                RbotAnalytics.logEvent(context, "automation_shizuku_pair_settings_tap")
            ...
            notificationOptions.setOnClickListener {
                RbotAnalytics.logEvent(context, "automation_shizuku_pair_notification_settings_tap")
    ...
    private fun startPairingService() {
        RbotAnalytics.logEvent(this, "automation_shizuku_pair_search_started")
